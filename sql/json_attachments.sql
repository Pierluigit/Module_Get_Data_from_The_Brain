...
-- Generation Time: Apr 10, 2020 at 09:38 PM
...
--
-- Table structure for table `json_attachments`
--

CREATE TABLE `json_attachments` (
...
--
-- Indexes for table `json_attachments`
--
ALTER TABLE `json_attachments`
...
--
-- AUTO_INCREMENT for table `json_attachments`
--
ALTER TABLE `json_attachments`
