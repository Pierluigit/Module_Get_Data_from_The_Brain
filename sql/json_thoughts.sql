...
--
-- Table structure for table `json_thoughts`
--

CREATE TABLE `json_thoughts` (
...
--
-- Indexes for table `json_thoughts`
--
ALTER TABLE `json_thoughts`
...
--
-- AUTO_INCREMENT for table `json_thoughts`
--
ALTER TABLE `json_thoughts`
